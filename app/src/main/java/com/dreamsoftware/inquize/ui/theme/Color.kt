...
val md_theme_light_errorContainer = Color(0xFFBA1A1A) // Red for errors
...
val md_theme_light_inversePrimary = Color(0xFFD1C4E9) // Inverse variant of primary color
val md_theme_light_shadow = Color(0xFF000000) // Shadow color
val md_theme_light_surfaceTint = Color(0xFF673AB7) // Tint for surfaces
...
// Dark Theme
val md_theme_dark_primary = Color(0xFF673AB7) // Deep Purple
val md_theme_dark_onPrimary = Color(0xFF311B92) // Darker Purple for primary text
val md_theme_dark_primaryContainer = Color(0xFF512DA8) // Medium Purple for primary containers in dark theme
val md_theme_dark_onPrimaryContainer = Color(0xFFEDE7F6) // Light Purple for text in primary containers
val md_theme_dark_secondary = Color(0xFF8E24AA) // Amethyst for secondary elements
val md_theme_dark_onSecondary = Color(0xFF4A0072) // Dark Amethyst for secondary text
val md_theme_dark_secondaryContainer = Color(0xFF6A1B9A) // Medium Amethyst for secondary containers
val md_theme_dark_onSecondaryContainer = Color(0xFFF3E5F5) // Light Amethyst for text in secondary containers
...
val md_theme_dark_inversePrimary = Color(0xFFD1C4E9) // Inverse variant of primary color
val md_theme_dark_shadow = Color(0xFF000000) // Shadow color
val md_theme_dark_surfaceTint = Color(0xFF673AB7) // Tint for surfaces
